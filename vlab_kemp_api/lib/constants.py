...
DEFINED = OrderedDict([
            ('VLAB_KEMP_LOG_LEVEL', environ.get('VLAB_KEMP_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'kemp-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_KEMP_IMAGES_DIR', environ.get('VLAB_KEMP_IMAGES_DIR', '/images')),
