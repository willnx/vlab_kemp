...
from vlab_kemp_api.lib.views import healthcheck
...
class TestHealthView(unittest.TestCase):
    ...
    def test_health_check(self):
        """A simple test to verify the /api/1/inf/kemp/healthcheck end point works"""
        resp = self.app.get('/api/1/inf/kemp/healthcheck')
